...
System.Console.WriteLine("Автоматически сгенерированный массив:");
PrintMatrix(matrix);
System.Console.WriteLine($"Сумма элементов массива по диогонали - {SumMatrix(matrix)}");
System.Console.WriteLine();
System.Console.WriteLine("Одномерный массив, состоящий из средних арифметических значений по строкам двумерного массива:");
PrintArray(MidlSum(matrix));
System.Console.WriteLine();
System.Console.WriteLine("Перезаписанный массив с возведенными в квадрат элементами, расположенными в четных строках и столбцах одновременно:");
